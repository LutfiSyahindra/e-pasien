...
class DaftarOnlinePageTest extends TestCase
{
    public function test_new_registration_page_shows_guarantor_notice_and_visit_fields(): void
    {
        ...
        $response
            ...
            ->assertSee('id="onlineMobileProgress"', false)
            ->assertSeeText('Langkah 1 dari 4 · Tanggal kunjungan')
            ->assertSee('id="onlineMobileProgressBar"', false)
            ->assertSee('id="onlineSidePanel"', false)
            ->assertSee('id="onlineVisitSummary"', false)
            ->assertSee('syncMobileSummaryPlacement();', false)
    ...
    public function test_configured_registration_role_sees_all_history_and_guarantor_filter(): void
    {
        ...
        $response
            ...
            ->assertSee('id="onlineHistoryMobileFilterToggle"', false)
            ->assertSee('aria-controls="onlineHistoryFilterPanel"', false)
            ->assertSee('id="onlineHistoryFilterPanel"', false)
            ->assertSeeText('Daftar Pendaftaran')
