                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <div class="user-setting d-flex align-items-center gap-1">
                            <img src="{{ $navbarUserPhoto }}" class="user-img"
                                alt="Foto {{ $navbarUserName }}" width="42" height="42" decoding="async" onerror="this.onerror=null;this.src='{{ $navbarDefaultPhoto }}';">
                            <div class="user-name d-none d-sm-block">{{ $navbarUserName }}</div>
                        </div>
                    </a>
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{ $navbarUserPhoto }}" alt="Foto {{ $navbarUserName }}"
                                        class="rounded-circle" width="60" height="60" decoding="async" onerror="this.onerror=null;this.src='{{ $navbarDefaultPhoto }}';">
                                    <div class="ms-3">
                                        <h6 class="mb-0 dropdown-user-name">{{ $navbarUserName }}</h6>
                                        <small class="mb-0 dropdown-user-designation text-secondary">{{ $navbarUserRole }}</small>
                                    </div>
                                </div>
                            </a>
                        </li>
