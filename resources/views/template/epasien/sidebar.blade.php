        @php
            ...
            $facilityMenuActive = request()->routeIs(
                "kamar.*",
                "laboratorium.*",
                "poliklinik.*",
                "radiologi.*",
        ...
        <aside class="sidebar-wrapper ep-premium-sidebar" aria-label="Navigasi utama">
            <div class="sidebar-header">
                ...
                <button type="button" class="toggle-icon ms-auto" aria-label="Ciutkan sidebar"
            ...
            <div class="ep-sidebar-tools">
                <label class="ep-sidebar-search" for="ep-sidebar-search">
                    ...
                    <input id="ep-sidebar-search" type="search" placeholder="Cari menu..."
                        autocomplete="off" aria-controls="menu">
