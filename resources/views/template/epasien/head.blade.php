<head>
    ...
    <!--plugins-->
    <link href="{{ versioned_asset("epasien/assets/plugins/simplebar/css/simplebar.css") }}" rel="stylesheet" />
    <link href="{{ versioned_asset("epasien/assets/plugins/metismenu/css/metisMenu.min.css") }}" rel="stylesheet" />
    @if ($usesDataTables)
        <link href="{{ versioned_asset("epasien/assets/plugins/datatable/css/dataTables.bootstrap5.min.css") }}" rel="stylesheet" />
    @endif
    @if ($usesSelect2)
        <link href="{{ versioned_asset("epasien/assets/plugins/select2/css/select2.min.css") }}" rel="stylesheet" />
        <link href="{{ versioned_asset("epasien/assets/plugins/select2/css/select2-bootstrap4.css") }}" rel="stylesheet" />
    @endif
    <!-- Bootstrap CSS -->
    ...
    @elseif ($usesSweetAlert)
        <link href="{{ versioned_asset("epasien/assets/css/sweetalert-premium.css") }}" rel="stylesheet" />
    @endif
    <link href="{{ versioned_asset("epasien/assets/css/sidebar-premium.css") }}" rel="stylesheet" />
    <link href="{{ versioned_asset("epasien/assets/css/notification-center.css") }}" rel="stylesheet" />
    @can("EPASIEN.MENU.PASIEN_SERVICE")
        <link href="{{ versioned_asset("epasien/assets/css/patient-service-navbar.css") }}" rel="stylesheet" />
    @endcan
    <link href="{{ versioned_asset("epasien/assets/css/navbar-premium.css") }}" rel="stylesheet" />
