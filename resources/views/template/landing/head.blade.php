<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset("landing/assets/images/fav.png") }}">
    ...
    <link rel="stylesheet" href="{{ asset("landing/assets/css/plugins/plugins.css") }}">
    <link rel="stylesheet" href="{{ asset("landing/assets/css/plugins/magnifying-popup.css") }}">
